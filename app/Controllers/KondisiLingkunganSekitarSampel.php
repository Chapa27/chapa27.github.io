...
class KondisiLingkunganSekitarSampel extends ResourceController
{
    ...
    public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan-pemeriksaan/Lhu/Kondisi-lingkungan/_data', $data)
            ];
    ...
    public function new()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan-pemeriksaan/Lhu/Kondisi-lingkungan/_add', $data)
            ];
    ...
    public function edit($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'sukses' => view('Backend/Modul/Pelayanan-pemeriksaan/Lhu/Kondisi-lingkungan/_edit', $data)
            ];
            echo json_encode($msg);
        } else {
            exit('Not Process');
