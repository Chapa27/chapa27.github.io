...
class KajiUlangPermintaanKontrak extends ResourceController
{
    ...
    {   
        ...
        return view('Backend/Modul/Pelayanan-pemeriksaan/Lhu/Kaji-ulang/index', $data);
    }
     ...
     public function list()
    {
        if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan-pemeriksaan/Lhu/Kaji-ulang/_data', $data)
            ];
    ...
    public function new()
    {
         if ($this->request->isAJAX()) {
            ...
            $msg = [
                'data' => view('Backend/Modul/Pelayanan-pemeriksaan/Lhu/Kaji-ulang/_add', $data)
            ];
